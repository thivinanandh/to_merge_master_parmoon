...
void  TriaReMeshGen(TDomain *&Domain)
{
  ...
  int  N_Verti, N_Hori_Top, N_Hori_Bottom,  N_BDVertices, N_Verti_left, N_Verti_right;
...
//   N_Verti = N_Points;       // number of vertical BD vertices
  ...
  N_Points = int (TDatabase::ParamDB->P6);    
  N_Hori_Top  = 20;      // number of horrizontal BD vertices
  N_Hori_Bottom  = 50;
  N_Verti_left = 80;       // number of vertical BD vertices
  N_Verti_right = 60;       // number of vertical BD vertices
   
//   N_BDVertices = N_Hori_Top+ N_Hori_Bottom + 2*N_Verti;  
  N_BDVertices = N_Hori_Top+ N_Hori_Bottom + N_Verti_left + N_Verti_right;  
