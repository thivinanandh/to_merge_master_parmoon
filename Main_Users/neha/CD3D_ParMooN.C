...
// =======================================================================
#include "../Main_Users/neha/Laplace.h"
...
#ifdef _CUDA
    CUDA_CHECK(cudaHostRegister(sol, N_DOF * sizeof(double), cudaHostRegisterPortable));

    CUDA_CHECK(cudaHostRegister(rhs, N_DOF * sizeof(double), cudaHostRegisterPortable));
#endif
...
#ifdef _CUDA
    CUDA_CHECK(cudaHostUnregister(sol));

    CUDA_CHECK(cudaHostUnregister(rhs));
 #endif 
//   for(i=0;i<mg_level;i++)
//    {
