...
# select this line accordingly to include your main program
 set(AParMooN_MODEL "${PROJECT_SOURCE_DIR}/Main_Users/neha/NSE3D_ParMooN.C" CACHE STRING "Enter to select the Main file of the model")
# set(AParMooN_MODEL "${PROJECT_SOURCE_DIR}/Main_Users/neha/CD3D_ParMooN.C" CACHE STRING "Enter to select the Main file of the model")
# set(AParMooN_MODEL "${PROJECT_SOURCE_DIR}/Main_Users/neha/CD2D_ParMooN.C" CACHE STRING "Enter to select the Main file of the model")
...
#  selection of program type (SEQUENTIAL SMPI MPI OMPONLY HYBRID SCUDA MCUDA )
set(AParMooN_PARALLEL_TYPE "MCUDA" CACHE STRING "select the parallel type")
...
set_property(CACHE AParMooN_PARALLEL_TYPE PROPERTY STRINGS SEQUENTIAL SMPI MPI OMPONLY HYBRID SCUDA MCUDA)
...
# ======================================================================
 ...
 elseif("${AParMooN_PARALLEL_TYPE}" STREQUAL "MCUDA")
    set(PARMOON_PRG_DEFINE "-D_PAR -D_CUDA -D_MPI -D_HYBRID")
 endif()
 ...
 elseif("${AParMooN_ARCH}" STREQUAL "INTEL64")
   set(PARMOON_CXX_DEF "${PARMOON_CXX_DEF} -O3 -std=c++11 -fopenmp -fma ")
   set(PARMOON_C_DEF "  ${PARMOON_C_DEF}   -DREDUCED -DNO_TIMER -DMKL_ILP64 -m64 -O3 -g -std=c++11 -fopenmp -fma ")
   set(PARMOON_CUDA_DEF "${PARMOON_CUDA_DEF} -O3 -Xcompiler -fopenmp -w -ldl -lpthread -lcusparse -lculibos -lcublas")
 ...
 elseif("${AParMooN_ARCH}" STREQUAL "CRAY64")
   ...
   set(PARMOON_C_DEF "  ${PARMOON_C_DEF}  -DREDUCED -DNO_TIMER -DMPICH_IGNORE_CXX_SEEK  ")
   set(PARMOON_CUDA_DEF "${PARMOON_CUDA_DEF} -arch=sm_70 -Xcompiler -fopenmp -w -ldl -lpthread -lcusparse -lculibos -lcublas")
 endif()
