...
set(AParMooN_OUTPUT_DIR_PATH "${CMAKE_SOURCE_DIR}/../ParMooN_Output/thivin3d_2" CACHE STRING "select the model")
...
# ======================================================================
 ...
 if("${AParMooN_ARCH}" STREQUAL "LINUX64")
   set(PARMOON_CXX_DEF "${PARMOON_CXX_DEF} -fma -AVX2 -std=c++14 -lmkl_rt -fopenmp")
